(() => {
  ...
  const translations = {
    ...
    "zh-TW": {
      ...
      "faq-a2": '空單過濾器已在 2025 Q4 上線運作。多單過濾器的開發需要足夠的崩盤樣本來建模，2026 年 1 月的 -5.65σ 事件提供了關鍵的數據樣態，使我們得以完成這項防護機制。另外，在 2025/11 之後為了避免熊市的肥尾事件帶來衝擊，官方已主動將多單曝險減半，此舉已將原本50%的回撤降低到25%。',
    ...
    "zh-CN": {
      ...
      "faq-a2": '空单过滤器已在 2025 Q4 上线运作。多单过滤器的开发需要足够的崩盘样本来建模，2026 年 1 月的 -5.65σ 事件提供了关键的数据样态，使我们得以完成这项防护机制。另外，在 2025/11 之后为了避免熊市的肥尾事件带来冲击，官方已主动将多单曝险减半，此举已将原本50%的回撤降低到25%。',
