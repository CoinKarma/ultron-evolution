(() => {
  ...
  const translations = {
    en: {
      ...
      "intro-body": 'We studied past major BTC crashes in depth and discovered that before each event, the Binance BTCUSDT perpetual contract\u2019s <strong>Long-Short Ratio (LSUR)</strong> and <strong>Open Interest</strong> consistently showed detectable anomalies. We had already developed the <strong>Short Filter</strong> in 2025 Q4. After this event, we further developed the <strong>Long Filter</strong>, completing the risk protection framework. Below is an introduction to the Filter mechanisms.',
      "sf-title": "Short Filter",
      "sf-body": 'Monitors <strong>Cumberland OTC</strong> transfer activity on-chain. When large transfers exceed sell-side liquidity thresholds, short entries are blocked to avoid false signals during strong uptrends.<br><a href="https://docs.coinkarma.co/indicators-guide/cumberland-usdt-distribution" target="_blank" style="color:var(--accent);text-decoration:underline;">CoinKarma Indicator Review & Guide</a>',
      ...
      "faq-a2": 'The Short Filter was already deployed and running in 2025 Q4. Developing the Long Filter required sufficient crash samples for modeling. The -5.65\u03c3 event in January 2026 provided the critical data patterns that enabled us to build and validate this protection layer. Additionally, after November 2025, to avoid the impact of fat-tail events in a bear market, the team proactively halved long exposure, which already reduced the original ~50% drawdown to ~25%. During the same period, BTC spot retraced over 50% from its highs, while Ultron with 3x leverage only drew down ~25% \u2014 already significantly outperforming spot holders \u2014 yet we continue to strengthen our protection mechanisms.',
      "faq-q3": "Is there a risk of overfitting in the newly added Long Filter?",
      "faq-a3": "The Long Filter has two layers. Layer 1 (MA Filter) is a trend-based position management mechanism: when price falls below key moving averages, the system automatically reduces long exposure rather than trying to predict specific crash events. This logic uses few parameters and doesn\u2019t depend on specific patterns, making overfitting risk very low. In two of the five major backtest events, the Layer 2 crash stop-loss wasn\u2019t even triggered \u2014 the MA Filter\u2019s exposure reduction alone was sufficient to control losses. Layer 2\u2019s crash detection does rely on a smaller sample set, but its role is supplementary insurance, not the primary line of defense.",
      "faq-q4": "Does the Filter reduce returns in bull markets?",
      "faq-a4": 'Quite the opposite. Backtests show that adding Filters <strong>significantly increased ROI</strong>. The reason: avoiding deep drawdowns means the portfolio doesn\u2019t have to climb out of a deep hole, and compounding effects accelerate equity growth.',
      "faq-q5": "Is the backtest period cherry-picked?",
      "faq-a5": 'No. The backtest covers <strong>August 2022 to present</strong>, spanning a full bull-bear cycle and 5 major crisis events: FTX bankruptcy, BOJ rate hike, tariff escalation, November 2025 sell-off, and the January 2026 crash.',
      "faq-q6": "Does the team trade with their own capital?",
      "faq-a6": 'Yes. Since CoinKarma launched in <strong>May 2024</strong>, the team\u2019s own capital has been trading the exact same strategy alongside subscribers, sharing the same gains and losses.',
      "faq-q7": "Why does the backtest start from August 2022? Can\u2019t it go further back?",
      "faq-a7": 'The earliest available data from our data sources begins on <strong>August 1, 2022</strong>. This period already covers multiple distinct market phases \u2014 including bear markets, recoveries, bull runs, and several major crash events \u2014 providing a comprehensive validation of the strategy\u2019s performance.',
      ...
      "footer-updated": "Last updated: 2026-02-13",
      "loading": "Loading...",
    ...
    "zh-TW": {
      ...
      "hero-subtitle": '2026 \u5E74 2 \u6708\uFF0C\u6BD4\u7279\u5E63\u7D93\u6B77 FTX \u7834\u7522\u4EE5\u4F86\u6700\u56B4\u91CD\u7684\u56DE\u6A94\uFF0C\u4E00\u500B 2010 \u5E74\u4EE5\u4F86\u50C5\u767C\u751F 4 \u6B21\u7684 <strong>-5.65\u03c3 \u6975\u7AEF\u4E8B\u4EF6</strong>\u3002Ultron \u7B56\u7565\u56DE\u64A4\u7D04 25%\uFF0C\u5718\u968A\u7684\u8CC7\u7522\u4E5F\u8207\u8A02\u95B1\u6703\u54E1\u5171\u540C\u627F\u53D7\u640D\u5931\u3002\u9762\u5C0D\u6DE8\u503C\u56DE\u64A4\uFF0C\u6211\u5011\u82B1\u8CBB\u4E86\u5927\u91CF\u6642\u9593\u7814\u7A76\u904E\u5F80\u5D29\u76E4\u3001\u6307\u6A19\u920D\u5316\u7684\u6578\u64DA\u6A23\u614B\uFF0C\u958B\u767C\u51FA\u4E86\u65B0\u7684\u591A\u55AE\u9632\u8B77\u6A5F\u5236\u3002\u56DE\u6E2C\u986F\u793A\uFF0C\u9019\u4E9B\u6A5F\u5236\u80FD\u5C07\u6700\u5927\u56DE\u64A4<strong>\u964D\u4F4E\u8FD1\u4E00\u534A</strong>\u3002',
      "hero-stat-roi-delta": "ROI \u63D0\u5347",
      "hero-stat-mdd-delta": "MDD \u6539\u5584",
      "hero-stats-note": "\u52A0\u5165 Long Filter \u5F8C\u7684\u6539\u9032\uFF08\u5C0D\u6BD4\u50C5\u6709 Short Filter\uFF09",
      "intro-body": '我們深入研究過去的 BTC 重大崩盤事件，發現崩盤前，幣安 BTCUSDT 永續合約的<strong>多空比（LSUR）</strong>與<strong>持倉量（Open Interest）</strong>往往都會出現可偵測的異常訊號。我們已在 2025 Q4 開發了<strong>空單過濾器（Short Filter）</strong>，經歷本次事件後，進一步開發<strong>多單過濾器（Long Filter）</strong>，完成風險防護機制。以下為加入 Filter 的機制介紹。',
      "sf-title": "\u7A7A\u55AE\u904E\u6FFE\u5668",
      "sf-body": '\u76E3\u63A7 <strong>Cumberland OTC</strong> \u93C8\u4E0A\u5927\u984D\u8F49\u5E33\u6D3B\u52D5\u3002\u7576\u8F49\u5E33\u91CF\u8D85\u904E\u8CE3\u65B9\u6D41\u52D5\u6027\u9580\u6ABB\u6642\uFF0C\u5C01\u9396\u7A7A\u55AE\u9032\u5834\uFF0C\u907F\u514D\u5F37\u52E2\u4E0A\u6F32\u4E2D\u7684\u5047\u4FE1\u865F\u3002<br><a href="https://docs.coinkarma.co/indicators-guide/cumberland-usdt-distribution" target="_blank" style="color:var(--accent);text-decoration:underline;">CoinKarma \u6307\u6A19\u5FA9\u76E4\u8207\u4ECB\u7D39</a>',
      "lf-title": "\u591A\u55AE\u904E\u6FFE\u5668\uFF1A\u591A\u5C64\u4FDD\u8B77",
      ...
      "faq-a2": '空單過濾器已在 2025 Q4 上線運作。多單過濾器的開發需要足夠的崩盤樣本來建模，2026 年 1 月的 -5.65σ 事件提供了關鍵的數據樣態，使我們得以完成這項防護機制。另外，在 2025/11 之後為了避免熊市的肥尾事件帶來衝擊，官方已主動將多單曝險減半，此舉已將原本50%的回撤降低到25%。同期 BTC 現貨從高點回撤超過 50%，Ultron 在 3 倍槓桿下實際回撤約 25%，已大幅優於持有現貨，但我們仍持續強化防護機制。',
      "faq-q3": "\u65B0\u589E\u7684 Long Filter \u662F\u5426\u6709\u56DE\u6E2C\u904E\u5EA6\u64EC\u5408\u7684\u98A8\u96AA\uFF1F",
      "faq-a3": "Long Filter \u5206\u70BA\u5169\u5C64\u3002\u7B2C\u4E00\u5C64 MA Filter \u662F\u57FA\u65BC\u8DA8\u52E2\u5F37\u5F31\u7684\u5009\u4F4D\u7BA1\u7406\u6A5F\u5236\uFF1A\u7576\u50F9\u683C\u8DCC\u7834\u95DC\u9375\u5747\u7DDA\u6642\uFF0C\u7CFB\u7D71\u81EA\u52D5\u964D\u4F4E\u591A\u55AE\u66DD\u96AA\uFF0C\u800C\u975E\u8A66\u5716\u9810\u6E2C\u7279\u5B9A\u5D29\u76E4\u4E8B\u4EF6\u3002\u9019\u7A2E\u908F\u8F2F\u53C3\u6578\u5C11\u3001\u4E0D\u4F9D\u8CF4\u7279\u5B9A\u6A21\u5F0F\uFF0C\u904E\u5EA6\u64EC\u5408\u7684\u98A8\u96AA\u5F88\u4F4E\u3002\u5728\u56DE\u6E2C\u7684\u4E94\u6B21\u91CD\u5927\u4E8B\u4EF6\u4E2D\uFF0C\u6709\u5169\u6B21\u751A\u81F3\u4E0D\u9700\u8981\u89F8\u767C\u7B2C\u4E8C\u5C64\u7684\u5D29\u76E4\u505C\u640D\uFF0C\u50C5\u9760 MA Filter \u964D\u4F4E\u66DD\u96AA\u5C31\u8DB3\u4EE5\u63A7\u5236\u640D\u5931\u3002\u7B2C\u4E8C\u5C64\u7684\u5D29\u76E4\u5075\u6E2C\u78BA\u5BE6\u4F9D\u8CF4\u8F03\u5C11\u7684\u6A23\u672C\uFF0C\u4F46\u5B83\u7684\u89D2\u8272\u662F\u984D\u5916\u4FDD\u96AA\uFF0C\u800C\u975E\u6838\u5FC3\u9632\u7DDA\u3002",
      "faq-q4": "Filter \u6703\u4E0D\u6703\u5728\u725B\u5E02\u964D\u4F4E\u6536\u76CA\uFF1F",
      "faq-a4": '\u6070\u6070\u76F8\u53CD\u3002\u56DE\u6E2C\u986F\u793A\u52A0\u5165 Filter \u5F8C <strong>ROI \u5927\u5E45\u63D0\u5347</strong>\u3002\u539F\u56E0\u662F\uFF1A\u907F\u958B\u5927\u5E45\u56DE\u64A4\u610F\u5473\u8457\u4E0D\u9700\u8981\u5F9E\u6DF1\u5751\u4E2D\u722C\u56DE\u4F86\uFF0C\u8907\u5229\u6548\u61C9\u53CD\u800C\u8B93\u6DE8\u503C\u6210\u9577\u66F4\u5FEB\u3002',
      "faq-q5": "\u56DE\u6E2C\u671F\u9593\u662F\u5426\u7D93\u904E\u7279\u5225\u6311\u9078\uFF1F",
      "faq-a5": '\u4E0D\u662F\u3002\u56DE\u6E2C\u6DB5\u84CB <strong>2022 \u5E74 8 \u6708\u81F3\u4ECA</strong>\uFF0C\u8DE8\u8D8A\u5B8C\u6574\u7684\u725B\u718A\u9031\u671F\uFF0C\u5305\u542B FTX \u7834\u7522\u3001\u65E5\u592E\u5347\u606F\u3001\u95DC\u7A05\u6230\u3001\u5341\u4E00\u6708\u6025\u8DCC\u53CA\u4E00\u6708\u5D29\u76E4\u5171 5 \u6B21\u91CD\u5927\u4E8B\u4EF6\u3002',
      "faq-q6": "\u5718\u968A\u81EA\u5DF1\u7684\u8CC7\u91D1\u4E5F\u5728\u8DD1\u9019\u500B\u7B56\u7565\u55CE\uFF1F",
      "faq-a6": '\u662F\u7684\u3002\u5F9E <strong>2024 \u5E74 5 \u6708</strong> CoinKarma \u7DB2\u7AD9\u4E0A\u7DDA\u7684\u7B2C\u4E00\u5929\u8D77\uFF0C\u5718\u968A\u7684\u81EA\u6709\u8CC7\u91D1\u5C31\u5DF2\u7D93\u540C\u6B65\u57F7\u884C\u5BE6\u76E4\u4EA4\u6613\uFF0C\u8207\u8A02\u95B1\u6703\u54E1\u5171\u540C\u627F\u64D4\u640D\u76CA\u3002',
      "faq-q7": "\u70BA\u4EC0\u9EBC\u56DE\u6E2C\u5F9E 2022/8/1 \u958B\u59CB\uFF0C\u4E0D\u80FD\u66F4\u65E9\u55CE\uFF1F",
      "faq-a7": '\u6578\u64DA\u6E90\u982D\u6700\u65E9\u53EF\u7528\u7684\u8CC7\u6599\u5F9E <strong>2022 \u5E74 8 \u6708 1 \u65E5</strong>\u958B\u59CB\u3002\u9019\u6BB5\u671F\u9593\u5DF2\u7D93\u6DB5\u84CB\u4E86\u591A\u7A2E\u4E0D\u540C\u7684\u5E02\u5834\u968E\u6BB5\u2014\u2014\u5305\u62EC\u718A\u5E02\u3001\u5FA9\u7526\u3001\u725B\u5E02\u4EE5\u53CA\u591A\u6B21\u91CD\u5927\u5D29\u76E4\u4E8B\u4EF6\u2014\u2014\u5DF2\u80FD\u5145\u5206\u9A57\u8B49\u7B56\u7565\u7684\u8868\u73FE\u3002',
      "footer-note": "\u8CC7\u6599\u7BC4\u570D\uFF1A2022-08-01 \u81F3\u4ECA\u3002\u904E\u53BB\u7E3E\u6548\u4E0D\u4EE3\u8868\u672A\u4F86\u8868\u73FE\u3002\u6240\u6709\u56DE\u6E2C\u4F7F\u7528 3 \u500D\u69D3\u687F\u3001MLD\uFF08\u591A\u5C64\u6B21\u52D5\u614B\uFF09\u6EFE\u52D5\u95BE\u503C\u30010.05% \u624B\u7E8C\u8CBB\u53CA\u6ED1\u50F9\u5047\u8A2D\u3002",
      "footer-updated": "\u6700\u5F8C\u66F4\u65B0\uFF1A2026-02-13",
      "loading": "\u8F09\u5165\u4E2D\u2026",
    ...
    "zh-CN": {
      ...
      "hero-subtitle": '2026 \u5E74 2 \u6708\uFF0C\u6BD4\u7279\u5E01\u7ECF\u5386 FTX \u7834\u4EA7\u4EE5\u6765\u6700\u4E25\u91CD\u7684\u56DE\u64A4\uFF0C\u4E00\u4E2A 2010 \u5E74\u4EE5\u6765\u4EC5\u53D1\u751F 4 \u6B21\u7684 <strong>-5.65\u03c3 \u6781\u7AEF\u4E8B\u4EF6</strong>\u3002Ultron \u7B56\u7565\u56DE\u64A4\u7EA6 25%\uFF0C\u56E2\u961F\u7684\u8D44\u4EA7\u4E5F\u4E0E\u8BA2\u9605\u4F1A\u5458\u5171\u540C\u627F\u53D7\u635F\u5931\u3002\u9762\u5BF9\u51C0\u503C\u56DE\u64A4\uFF0C\u6211\u4EEC\u82B1\u8D39\u4E86\u5927\u91CF\u65F6\u95F4\u7814\u7A76\u8FC7\u5F80\u5D29\u76D8\u3001\u6307\u6807\u949D\u5316\u7684\u6570\u636E\u6837\u6001\uFF0C\u5F00\u53D1\u51FA\u4E86\u65B0\u7684\u591A\u5355\u9632\u62A4\u673A\u5236\u3002\u56DE\u6D4B\u663E\u793A\uFF0C\u8FD9\u4E9B\u673A\u5236\u80FD\u5C06\u6700\u5927\u56DE\u64A4<strong>\u964D\u4F4E\u8FD1\u4E00\u534A</strong>\u3002',
      "hero-stat-roi-delta": "ROI \u63D0\u5347",
      "hero-stat-mdd-delta": "MDD \u6539\u5584",
      "hero-stats-note": "\u52A0\u5165 Long Filter \u540E\u7684\u6539\u8FDB\uFF08\u5BF9\u6BD4\u4EC5\u6709 Short Filter\uFF09",
      "intro-body": '我们深入研究过去的 BTC 重大崩盘事件，发现崩盘前，币安 BTCUSDT 永续合约的<strong>多空比（LSUR）</strong>与<strong>持仓量（Open Interest）</strong>往往都会出现可侦测的异常信号。我们已在 2025 Q4 开发了<strong>空单过滤器（Short Filter）</strong>，经历本次事件后，进一步开发<strong>多单过滤器（Long Filter）</strong>，完成风险防护机制。以下为加入 Filter 的机制介绍。',
      "sf-title": "\u7A7A\u5355\u8FC7\u6EE4\u5668",
      "sf-body": '\u76D1\u63A7 <strong>Cumberland OTC</strong> \u94FE\u4E0A\u5927\u989D\u8F6C\u8D26\u6D3B\u52A8\u3002\u5F53\u8F6C\u8D26\u91CF\u8D85\u8FC7\u5356\u65B9\u6D41\u52A8\u6027\u9608\u503C\u65F6\uFF0C\u5C01\u9501\u7A7A\u5355\u8FDB\u573A\uFF0C\u907F\u514D\u5F3A\u52BF\u4E0A\u6DA8\u4E2D\u7684\u5047\u4FE1\u53F7\u3002<br><a href="https://docs.coinkarma.co/indicators-guide/cumberland-usdt-distribution" target="_blank" style="color:var(--accent);text-decoration:underline;">CoinKarma \u6307\u6807\u590D\u76D8\u4E0E\u4ECB\u7ECD</a>',
      "lf-title": "\u591A\u5355\u8FC7\u6EE4\u5668\uFF1A\u591A\u5C42\u4FDD\u62A4",
      ...
      "faq-a2": '空单过滤器已在 2025 Q4 上线运作。多单过滤器的开发需要足够的崩盘样本来建模，2026 年 1 月的 -5.65σ 事件提供了关键的数据样态，使我们得以完成这项防护机制。另外，在 2025/11 之后为了避免熊市的肥尾事件带来冲击，官方已主动将多单曝险减半，此举已将原本50%的回撤降低到25%。同期 BTC 现货从高点回撤超过 50%，Ultron 在 3 倍杠杆下实际回撤约 25%，已大幅优于持有现货，但我们仍持续强化防护机制。',
      "faq-q3": "\u65B0\u589E\u7684 Long Filter \u662F\u5426\u6709\u56DE\u6D4B\u8FC7\u5EA6\u62DF\u5408\u7684\u98CE\u9669\uFF1F",
      "faq-a3": "Long Filter \u5206\u4E3A\u4E24\u5C42\u3002\u7B2C\u4E00\u5C42 MA Filter \u662F\u57FA\u4E8E\u8D8B\u52BF\u5F3A\u5F31\u7684\u4ED3\u4F4D\u7BA1\u7406\u673A\u5236\uFF1A\u5F53\u4EF7\u683C\u8DCC\u7834\u5173\u952E\u5747\u7EBF\u65F6\uFF0C\u7CFB\u7EDF\u81EA\u52A8\u964D\u4F4E\u591A\u5355\u66DD\u9669\uFF0C\u800C\u975E\u8BD5\u56FE\u9884\u6D4B\u7279\u5B9A\u5D29\u76D8\u4E8B\u4EF6\u3002\u8FD9\u79CD\u903B\u8F91\u53C2\u6570\u5C11\u3001\u4E0D\u4F9D\u8D56\u7279\u5B9A\u6A21\u5F0F\uFF0C\u8FC7\u5EA6\u62DF\u5408\u7684\u98CE\u9669\u5F88\u4F4E\u3002\u5728\u56DE\u6D4B\u7684\u4E94\u6B21\u91CD\u5927\u4E8B\u4EF6\u4E2D\uFF0C\u6709\u4E24\u6B21\u751A\u81F3\u4E0D\u9700\u8981\u89E6\u53D1\u7B2C\u4E8C\u5C42\u7684\u5D29\u76D8\u6B62\u635F\uFF0C\u4EC5\u9760 MA Filter \u964D\u4F4E\u66DD\u9669\u5C31\u8DB3\u4EE5\u63A7\u5236\u635F\u5931\u3002\u7B2C\u4E8C\u5C42\u7684\u5D29\u76D8\u4FA6\u6D4B\u786E\u5B9E\u4F9D\u8D56\u8F83\u5C11\u7684\u6837\u672C\uFF0C\u4F46\u5B83\u7684\u89D2\u8272\u662F\u989D\u5916\u4FDD\u9669\uFF0C\u800C\u975E\u6838\u5FC3\u9632\u7EBF\u3002",
      "faq-q4": "Filter \u4F1A\u4E0D\u4F1A\u5728\u725B\u5E02\u964D\u4F4E\u6536\u76CA\uFF1F",
      "faq-a4": '\u6070\u6070\u76F8\u53CD\u3002\u56DE\u6D4B\u663E\u793A\u52A0\u5165 Filter \u540E <strong>ROI \u5927\u5E45\u63D0\u5347</strong>\u3002\u539F\u56E0\u662F\uFF1A\u907F\u5F00\u5927\u5E45\u56DE\u64A4\u610F\u5473\u7740\u4E0D\u9700\u8981\u4ECE\u6DF1\u5751\u4E2D\u722C\u56DE\u6765\uFF0C\u590D\u5229\u6548\u5E94\u53CD\u800C\u8BA9\u51C0\u503C\u589E\u957F\u66F4\u5FEB\u3002',
      "faq-q5": "\u56DE\u6D4B\u671F\u95F4\u662F\u5426\u7ECF\u8FC7\u7279\u522B\u6311\u9009\uFF1F",
      "faq-a5": '\u4E0D\u662F\u3002\u56DE\u6D4B\u6DB5\u76D6 <strong>2022 \u5E74 8 \u6708\u81F3\u4ECA</strong>\uFF0C\u8DE8\u8D8A\u5B8C\u6574\u7684\u725B\u718A\u5468\u671F\uFF0C\u5305\u542B FTX \u7834\u4EA7\u3001\u65E5\u592E\u52A0\u606F\u3001\u5173\u7A0E\u6218\u3001\u5341\u4E00\u6708\u6025\u8DCC\u53CA\u4E00\u6708\u5D29\u76D8\u5171 5 \u6B21\u91CD\u5927\u4E8B\u4EF6\u3002',
      "faq-q6": "\u56E2\u961F\u81EA\u5DF1\u7684\u8D44\u91D1\u4E5F\u5728\u8DD1\u8FD9\u4E2A\u7B56\u7565\u5417\uFF1F",
      "faq-a6": '\u662F\u7684\u3002\u4ECE <strong>2024 \u5E74 5 \u6708</strong> CoinKarma \u7F51\u7AD9\u4E0A\u7EBF\u7684\u7B2C\u4E00\u5929\u8D77\uFF0C\u56E2\u961F\u7684\u81EA\u6709\u8D44\u91D1\u5C31\u5DF2\u7ECF\u540C\u6B65\u6267\u884C\u5B9E\u76D8\u4EA4\u6613\uFF0C\u4E0E\u8BA2\u9605\u4F1A\u5458\u5171\u540C\u627F\u62C5\u635F\u76CA\u3002',
      "faq-q7": "\u4E3A\u4EC0\u4E48\u56DE\u6D4B\u4ECE 2022/8/1 \u5F00\u59CB\uFF0C\u4E0D\u80FD\u66F4\u65E9\u5417\uFF1F",
      "faq-a7": '\u6570\u636E\u6E90\u5934\u6700\u65E9\u53EF\u7528\u7684\u6570\u636E\u4ECE <strong>2022 \u5E74 8 \u6708 1 \u65E5</strong>\u5F00\u59CB\u3002\u8FD9\u6BB5\u671F\u95F4\u5DF2\u7ECF\u6DB5\u76D6\u4E86\u591A\u79CD\u4E0D\u540C\u7684\u5E02\u573A\u9636\u6BB5\u2014\u2014\u5305\u62EC\u718A\u5E02\u3001\u590D\u82CF\u3001\u725B\u5E02\u4EE5\u53CA\u591A\u6B21\u91CD\u5927\u5D29\u76D8\u4E8B\u4EF6\u2014\u2014\u5DF2\u80FD\u5145\u5206\u9A8C\u8BC1\u7B56\u7565\u7684\u8868\u73B0\u3002',
      "footer-note": "\u6570\u636E\u8303\u56F4\uFF1A2022-08-01 \u81F3\u4ECA\u3002\u8FC7\u53BB\u7EE9\u6548\u4E0D\u4EE3\u8868\u672A\u6765\u8868\u73B0\u3002\u6240\u6709\u56DE\u6D4B\u4F7F\u7528 3 \u500D\u6760\u6746\u3001MLD\uFF08\u591A\u5C42\u6B21\u52A8\u6001\uFF09\u6EDA\u52A8\u9608\u503C\u30010.05% \u624B\u7EED\u8D39\u53CA\u6ED1\u70B9\u5047\u8BBE\u3002",
      "footer-updated": "\u6700\u540E\u66F4\u65B0\uFF1A2026-02-13",
      "loading": "\u52A0\u8F7D\u4E2D\u2026",
